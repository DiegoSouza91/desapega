    ...
    if (contactForm.length) {
        contactForm.validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                $target.html("<div class='alert alert-success'><p>Todos os campos são obrigatório.</p></div>");
            } else {
                $.ajax({
                    ...
                    beforeSend: function () {
                        $target.html("<div class='alert alert-info'><p>Carregando ...</p></div>");
                    },
                    success: function (text) {
                        if (text === "success") {
                            $this[0].reset();
                            $target.html("<div class='alert alert-success'><p>Mensagem enviada.</p></div>");
                        } else {
