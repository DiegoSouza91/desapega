                    ...
                    <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12 mb--sm">
                        <div class="gradient-wrapper">
                            <div class="gradient-title">
                                <h2>Para saber quem somos</h2>
                            </div>
                            <div class="about-us gradient-padding">
                                <img src="img/banner/about.jpeg" alt="about" class="img-fluid">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12">
                        <div class="sidebar-item-box">
                            <ul class="sidebar-more-option">
                                <li>
                                    <a href="post-ad.html"><img src="img/banner/more1.png" alt="more" class="img-fluid">Anuncie</a>
                                </li>
                                <li>
                                    <a href="#"><img src="img/banner/more2.png" alt="more" class="img-fluid">Gerenciar Produto(s)</a>
                                </li>
                                <li>
                                    <a href="favourite-ad-list.html"><img src="img/banner/more3.png" alt="more" class="img-fluid">Anúncios favoritos</a>
                                </li>
                            </ul>
                        </div>
                        <div class="sidebar-item-box">
