...
<section class="s-space-bottom-full bg-accent-shadow-body">
    <div class="container">
        <div class="breadcrumbs-area">
            <ul>
                ...
                <li><a href="?=anuncios">Eletrônicos</a> -</li>
    ...
    <div class="container">
                    ...
                    <div class="gradient-padding reduce-padding">
                        <div class="single-product-img-layout1 d-flex mb-50">
                            <ul class="nav tab-nav tab-nav-list">
                                <li class="nav-item">
                                    <a class="active" href="#related1" data-toggle="tab" aria-expanded="false"><img alt="related1" src="img/product/single-product1.jpeg" class="img-fluid"></a>
                                </li>
                                <li class="nav-item">
                                    <a href="#related2" data-toggle="tab" aria-expanded="false"><img alt="related2" src="img/product/single-product2.jpeg" class="img-fluid"></a>
                                </li>
                                <li class="nav-item">
                                    <a href="#related3" data-toggle="tab" aria-expanded="false"><img alt="related3" src="img/product/single-product3.jpeg" class="img-fluid"></a>
                                </li>
                                <li class="nav-item">
                                    <a href="#related4" data-toggle="tab" aria-expanded="false"><img alt="related4" src="img/product/single-product4.jpeg" class="img-fluid"></a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <span class="price">R$ 1,550</span>
                                <div class="tab-pane fade active show" id="related1">
                                    <a href="#" class="zoom ex1"><img alt="single" src="img/product/single-product1.jpeg" class="img-fluid"></a>
                                </div>
                                <div class="tab-pane fade" id="related2">
                                    <a href="#" class="zoom ex1"><img alt="single" src="img/product/single-product2.jpeg" class="img-fluid"></a>
                                </div>
                                <div class="tab-pane fade" id="related3">
                                    <a href="#" class="zoom ex1"><img alt="single" src="img/product/single-product3.jpeg" class="img-fluid"></a>
                                </div>
                                <div class="tab-pane fade" id="related4">
                                    <a href="#" class="zoom ex1"><img alt="single" src="img/product/single-product4.jpeg" class="img-fluid"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-5 col-sm-12 col-12 mb--sm">
                                ...
                                <ul class="sidebar-item-details p-none">
                                    <li>Situação:<span>New</span></li>
                                    <li>Marca:<span>Apple</span></li>
                                    <li>Cor:<span>White</span></li>
                                    <li>Garantia:<span>1 Year</span></li>
                                    <li>
                        ...
                        <ul class="item-actions border-top">
                            <li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i>Favorito</a></li>
                            <li><a href="#"><i class="fa fa-share-alt" aria-hidden="true"></i>Compartilhar</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#report_abuse"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>Reportar abuso</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="sidebar-item-box">
                    <div class="gradient-wrapper">
                        ...
                        <ul class="sidebar-item-details">
                            <li>Condição:<span>New</span></li>
                            <li>Marca:<span>Apple</span></li>
                            <li>Cor:<span>White</span></li>
                            <li>Garantia:<span>1 Year</span></li>
                            <li>
                                <ul class="sidebar-social">
                                    <h4 class="font-weight-bold">Compartilhar:</h4>
                                    <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                    <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                    <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                    <li><a href="#"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
        ...
        <div class="gradient-wrapper">
            <div class="gradient-title">
                <h2>Mais anuncios desse usuário </h2>
            </div>
